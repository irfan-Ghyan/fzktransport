...
const Corprate = () => {
  ...
  return (
    <div className="w-full px-4 lg:px-[0px] xl:px-[0px] max-w-full overflow-hidden md:pr-6 pt-[40px] lg:pt-[100px] pb-[80px] ">
      ...
      <div className='flex flex-col justify-between mt-[36px] lg:mb-[41px]'>
          ...
          <div >
            ...
            From Corporate milestones to personal celebrations, Teleios Dome is your premier destination for private events Whether you are planning a corporate gathering, product launch, team-building session, or personal celebration, our versatile venue and dedicated team ensure an unforgettable experience tailored to your needs.
            </p>
          </div>
          ...
          <div className="relative" style={{ paddingBottom: '56.25%', height: 0 }}>
            ...
            {!isPlaying && (
              <div className="absolute inset-0 flex items-center justify-center">
                <button
                  className="w-[49px] h-[33px] md:w-[99px] md:h-[63px] bg-gradient-to-r from-[#D00746] to-[#7E51F8] p-2 flex items-center justify-center"
                  onClick={handlePlayPause}
                >
                  {/* <span className="text-white md:text-[40px] ">▶</span> */}
              <Image src="/assets/video/play.png" width={40} height={40} alt='play' className="text-white md:text-[40px] "/>
                </button>
              </div>
            )}
          </div>
