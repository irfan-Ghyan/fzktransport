...
const DomeData = () => {
  ...
  return (
    <div className="relative w-full max-w-full overflow-hidden h-[600px] xl:h-[700px] bg-cover bg-center px-4 md:px-0" style={{ backgroundImage: "url('/assets/images/dome/slider1.png')" }}>
 <div className="absolute  inset-0 px-4 md:flex md:flex-col md:pr-6 py-[50px] lg:py-[100px] max-w-7xl mx-auto">
   <div className='px-4 flex flex-col justify-between md:mt-[36px] md:mb-[41px]'>
     ...
     <div className='py-10'>
       <Link href="/explore"  className="button-slanted w-[200px] lg:w-[233px] h-[44px] px-8 py-6 button font-jura font-bold bg-gradient-to-r from-[#7E51F8] to-[#D007A6] text-white ml-2 transition duration-300 rounded-tl-lg rounded-br-lg flex items-center justify-center">
