  ...
  return (
    <div className="min-h-screen overflow-x-hidden max-w-7xl mx-auto pb-[60px]">
      <div className='my-[60px]'>
        <div className="w-full max-w-7xl mx-auto mt-[70px]">
          <Link href="/experience" className="flex items-center text-[14px] text-white font-bold font-jura">
            <Image src={back} className="w-5 h-5 mr-2" alt="Back" />
